...
public class QuestionProvider extends ContentProvider {
    ...
    private static final String PROVIDER_NAME_QUESTIONS = "fr.doranco.myquizz.controller.QuestionProvider";
    public static final Uri CONTENT_QUESTIONS_URI = Uri.parse("content://" + PROVIDER_NAME_QUESTIONS + "/" + TABLE_NAME_QUESTIONS);
    ...
    static {
        ...
        uriMatcher.addURI(PROVIDER_NAME_QUESTIONS, "questions", uriCode);
        uriMatcher.addURI(PROVIDER_NAME_QUESTIONS, "questions/*", uriCode);
        uriMatcher.addURI(PROVIDER_NAME_QUESTIONS, "questions/#", uriCode);
    ...
    public Cursor query(@NonNull Uri uri,
        ...
        queryBuilder.setTables(TABLE_NAME_QUESTIONS);
    ...
    public Uri insert(Uri uri, ContentValues values) throws SQLiteException {
        ...
        Long rowId = db.insert(TABLE_NAME_QUESTIONS, "", values);
        if (rowId > 0) {
        ...
        throw new SQLiteException("Erreur lors de l'insertion" + CONTENT_QUESTIONS_URI);
    }
    ...
    public int delete(@NonNull Uri uri, @Nullable String selection, @Nullable String[] selectionArgs) {
        ...
        switch(uriMatcher.match(uri)){
            case uriCode :
                count = db.delete(TABLE_NAME_QUESTIONS, selection, selectionArgs);
                break;
            default :
                throw new IllegalArgumentException("URI inconnue : " + uri);
        }
    ...
    public int update(@NonNull Uri uri,
        ...
        switch(uriMatcher.match(uri)){
            case uriCode :
                count = db.update(TABLE_NAME_QUESTIONS, values, selection, selectionArgs);
                break;
            default :
                throw new IllegalArgumentException("URI inconnue : " + uri);
        }
